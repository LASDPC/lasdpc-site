...
> `../banco-de-dados/projetos/smart-lasdpc.md`.
> **Fontes:** `Smart LaSDPC.html`, `About the project.html`.
...
### EN
> The research group works with modern technologies that are trending in
...
### PT
> Inscreva-se para acesso beta. *(Provavelmente remover.)*
